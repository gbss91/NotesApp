...
class UserTest < ActiveSupport::TestCase
  ...
  test 'should not accept weak password' do
    user = User.new({ first_name: 'Paul', last_name: 'Brown', email: 'paul@test.com',
                      encrypted_password: '123456'})
    assert_not user.save, 'Saved the user with weak password'
  end
